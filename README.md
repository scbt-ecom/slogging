...
| SetJSONFormat(bool) | JSON формат логов если true в стандартном потоке вывода                                                                                                                                                                            | Текстовый формат логов в стандартном потоке вывода если false                            |
...
Что то не так с AnyAttr, надо разобраться, нужен наверное метод куда ссылку на структуру передаешь, а он ее норм раскладывает, а то сейчас с этим проблемы
